...
class CustomBEVFormerOcc3dgs(MVXTwoStageDetector):
    """BEVFormer.
    Args:
    ...
    def __init__(self,
        ...
        super(CustomBEVFormerOcc3dgs,
              self).__init__(pts_voxel_layer, pts_voxel_encoder,
                             pts_middle_encoder, pts_fusion_layer,
                             img_backbone, pts_backbone, img_neck, pts_neck,
                             pts_bbox_head, img_roi_head, img_rpn_head,
                             train_cfg, test_cfg, pretrained,
                            #  occ_vae, pretrain_head
                             )
    ...
    def forward_pts_train(self,
        ...
        target_dict = dict()
        target_dict['target_imgs'] = target_imgs
        target_dict['input_img'] = img

        loss_inputs = [voxel_semantics, mask_camera, outs]
        losses = self.pts_bbox_head.loss(*loss_inputs, img_metas=img_metas, target_dict=target_dict)
        return losses
    ...
    def forward_train(self,
        ...
        losses_pts = self.forward_pts_train(img_feats, gt_bboxes_3d,
                                            ...
                                            gt_bboxes_ignore, prev_bev, img, target_imgs)
